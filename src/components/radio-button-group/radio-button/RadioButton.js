...
var RadioButton = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("label", { className: "radio-button-input__label button button--outline " + (isActive ? 'button--outline--activated' : ''), htmlFor: id, onClick: function () { return setActive(id); } /* When current radio button is selected, sets it as the active one */ },
